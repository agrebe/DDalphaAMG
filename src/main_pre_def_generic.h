 ...
 */
  ...
  typedef struct {
    ...
    #define PROF_PRECISION_START_THREADED( TYPE ) PROF_PRECISION_START_UNTHREADED( TYPE )
    ...
    #define PROF_PRECISION_STOP_THREADED( TYPE, COUNT ) PROF_PRECISION_STOP_UNTHREADED( TYPE, COUNT )
  #else
    #define PROF_PRECISION_START_UNTHREADED( TYPE )
    #define PROF_PRECISION_START_THREADED( TYPE )
    #define PROF_PRECISION_STOP_UNTHREADED( TYPE, COUNT )
    #define PROF_PRECISION_STOP_THREADED( TYPE, COUNT )
  #endif
